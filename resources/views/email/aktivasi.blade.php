                                    ...
                                    <div style="height: 100%;width: 100% !important;">
                                        <div
                                            ...
                                            <table style="font-family:'Lato',sans-serif;" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:30px 10px 30px;font-family:'Lato',sans-serif;"
                                                            align="left">
                                                            ...
                                                            <div
                                                                ...
                                                                <p
                                                                    ...
                                                                    <span
                                                                        style="font-size: 28px; line-height: 39.2px; color: #ffffff; font-family: Lato, sans-serif;">Silahkan
                                                                        Reset Password Anda</span></p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:40px 40px 30px;font-family:'Lato',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 18px; line-height: 25.2px; color: #666666; font-family: Lato, sans-serif;"><span
                                                                            style="color: #252525; font-size: 18px; white-space: normal; background-color: #ffffff; float: none; display: inline; line-height: 25.2px;">Kami
                                                                            telah mengirimkan email ini kepada Anda
                                                                            sebagai tanggapan atas permintaan Anda untuk
                                                                            mengatur ulang kata sandi
                                                                            Anda</span>.</span></p>
                                                                <p style="font-size: 14px; line-height: 140%;"> </p>
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 18px; line-height: 25.2px; color: #666666;">Untuk
                                                                        mengatur ulang kata sandi Anda, silakan ikuti
                                                                        tautan di bawah ini : </span></p>
                                                            </div>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:0px 40px;font-family:'Lato',sans-serif;"
                                                            ...
                                                            <div align="left">
                                                                <a href="{{ route('reset-password', $aktivasi->id_users) }}" target="_blank" class="v-button"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="color: #888888; font-size: 14px; line-height: 19.6px;"><em><span
                                                                                style="font-size: 16px; line-height: 22.4px;">Harap
                                                                                abaikan email ini jika anda tidak
                                                                                meminta perubahan kata
                                                                                sandi.</span></em></span><br /><span
                                                                        style="color: #888888; font-size: 14px; line-height: 19.6px;"><em><span
